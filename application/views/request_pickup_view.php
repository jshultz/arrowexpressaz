    ...
    <div class="small-10 small-centered">
        <div id="" class="row">
            <div id="" class="small-12 medium-9 columns">
                ...
                <p class="notice"><strong>Please note, if you need to schedule a pickup for today please call our office
                        at:<br/> 928-639-3533</strong></p>
                <form action="/customers/submit_pickup_request" method="post" class="inline">
                    ...
                    <fieldset>
                        ...
                        <p>Don't see the address your looking for? <a href="/customers/shipping_info">Click here to add a new
                                address.</a></p>
                        <br/>
