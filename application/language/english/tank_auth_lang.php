...
$lang['auth_incorrect_captcha'] = 'Your confirmation code does not match the one in the image. Remember, it is case sensitive.';
$lang['auth_captcha_expired'] = 'Your confirmation code has expired. Please try again.';

// Notifications
$lang['auth_message_logged_out'] = 'You have been successfully logged out. Click here to return <a href="/">Home</a>.';
$lang['auth_message_registration_disabled'] = 'Registration is disabled.';
$lang['auth_message_registration_completed_1'] = 'You have successfully registered. Check your email account to activate your account. Your email may appear in your spam folder so check there if it is not in your inbox.';
...
$lang['auth_message_activation_completed'] = 'Your account has been successfully activated. Click here to return <a href="/">Home</a>.';
...
$lang['auth_message_new_password_sent'] = 'An email with instructions for creating a new password has been sent to you. Your email may appear in your spam folder so check there if it is not in your inbox.';
...
$lang['auth_message_new_email_sent'] = 'A confirmation email has been sent to %s. Follow the instructions in the email to complete this change of email address. Your email may appear in your spam folder so check there if it is not in your inbox.';
...
$lang['auth_message_unregistered'] = 'Your account has been deleted... Click here to return <a href="/">Home</a>.';
